...
def _scripted_action(task_id: str, step: int) -> str:
    ...
    scripts = {
        "easy_oom": [
            ...
            '{"action_type": "diagnose", "target": "api-gateway", "command": "Memory leak in api-gateway v2.4.1 causing OOM - request body caching"}',
        ...
        "medium_db_pool": [
            ...
            '{"action_type": "diagnose", "target": "user-service", "command": "Connection leak in user-service bulk sync exhausting DB pool"}',
        ...
        "hard_canary": [
            ...
            '{"action_type": "investigate", "target": "recommendation-service", "command": "logs"}',
            '{"action_type": "investigate", "target": "system", "command": "recent_changes"}',
            '{"action_type": "diagnose", "target": "auth-service", "command": "Canary deployment v5.1.0 has OAuth provider-B token validation bug"}',
